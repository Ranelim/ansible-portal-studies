...
export const DEMO_TEMPLATES: DemoTemplate[] = [
  ...
  },
  {
    ...
    description:
      'Pre-configured for cloud infrastructure provisioning with relevant cloud collections, credential structure, and dynamic inventory plugins for AWS, Azure, or GCP. Includes quality scanning.',
  ...
  },
  {
    ...
    description:
      'Network device configuration and compliance management with collections for Cisco, Juniper, or Arista platforms. Includes NETCONF/RESTCONF/SSH connection profiles and quality scanning.',
