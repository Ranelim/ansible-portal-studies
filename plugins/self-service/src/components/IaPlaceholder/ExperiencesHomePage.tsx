...
> = {
  ...
  develop: {
    ...
    summary: 'Create and manage automation content. Ecosystem tabs stay on each entity page.',
    metric: '12',
    metricLabel: 'repos',
  },
  compliance: {
    plugins: ['Compliance'],
    railItems: ['Templates', 'Activity', 'Inventories'],
    landing: '/self-service/inventories',
    summary:
      'Scan and remediate host inventories. Dashboard / Scans / Profiles are page tabs — Admin integrations live in Administration.',
    metric: '3',
    metricLabel: 'open findings',
  },
  edge: {
    plugins: ['RHEM / Flight Control'],
    railItems: ['Templates', 'Activity', 'Edge fleets'],
    landing: '/self-service/edge-fleets',
    summary:
      'Edge fleet lifecycle. Devices / Images are page tabs — not rail items; Admin config in Administration.',
    metric: '2',
    metricLabel: 'fleets',
  },
  admin: {
    ...
    summary:
      'Platform configuration only — Integrations and content sources live here, not as Manage inside other experiences.',
    metric: '4',
