 ...
 *
 * Portal adaptation: onOpen callback instead of extensions route refs.
 * Visual markup / sx / BadgeTriange / PluginIcon / CategoryLinkButton unchanged.
 */
...
export const PluginCard = ({
  ...
  onOpen: (plugin: ExtensionsPlugin) => void;
  onCategoryClick?: (category: string) => void;
}) => {
  const category = plugin.spec?.categories?.[0];
