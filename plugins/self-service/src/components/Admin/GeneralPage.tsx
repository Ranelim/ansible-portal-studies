...
const QUICK_START_STEPS = [
  {
    label: 'Connect to Ansible Automation Platform',
    description: 'Connect to Ansible Automation Platform to import job templates, collections, and credentials.',
    done: true,
  ...
  return (
    <Page themeId="app">
      <Header
        ...
        subtitle="Portal configuration and deployment status"
      />
      <Content>

        {/* Complete your configuration — collapsible, open by default while steps remain */}
          ...
          <CardContent style={{ paddingBottom: progressOpen ? undefined : 16 }}>
            ...
            <Collapse in={progressOpen}>
              <Typography className={classes.sectionDescription} style={{ marginTop: 4 }}>
                Finish setting up your portal. Complete all steps to unlock the full experience.
              </Typography>
